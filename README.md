...
ChargeFW2 is the computational core of [Atomic Charge Calculator](https://acc.biodata.ceitec.cz).

See the [short description](https://acc.biodata.ceitec.cz/methods.pdf) of implemented methods.
...
## How to cite
If you found ChargeFW2 or Atomic Charge Calculator helpful, please cite:
